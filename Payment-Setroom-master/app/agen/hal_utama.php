<br> <br>
<?php  
	include 'C:/xampp/htdocs/Payment-Setroom-master/app/config/koneksi.php';
	include 'C:/xampp/htdocs/Payment-Setroom-master/app/library/fungsi.php';
						...
						<ul class="nav navbar-nav navbar-right" style="margin-right: 50px;">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" id="akun">
									...
									<strong><?php echo isset($_SESSION['nama_agen']) ? $_SESSION['nama_agen'] : 'Guest'; ?></strong>&nbsp;
									<span class="caret"></span>
								</a>
